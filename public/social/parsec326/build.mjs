// Carosello "Parsec 3.26" — case study, design system Dielle Communication.
// 1 hook + 1 cover + 5 slide lavoro su card pulita (stile ninjastickers/coffeeworld).
...
<style>
  *{margin:0;padding:0;box-sizing:border-box;-webkit-font-smoothing:antialiased;text-rendering:geometricPrecision}
  ...
  .tagline{font-family:'Instrument Serif',Georgia,serif;font-style:italic;font-size:44px;
...
const slides = [
  // 1 — HOOK: logo restyled (marchio) su bianco
  work("Il lavoro", one("_logo.png", "Logo Parsec 3.26 restyled"),
    "Restyling logo & marchio", "SCORRI →", "pad", "#ffffff"),
  // 2 — COVER (navy)
  frame({
    kicker: "Case Study · IT · e-Government",
    dark: true, footnav: "→",
    body: `<div class="covernames">
        <div class="bn">Parsec</div>
        <div class="bn acc">3.26</div>
      </div>
      <div class="tagline">La nostra passione: l'e-government</div>
      <hr class="rulemint">
      <div class="discipline">Restyling logo · Corporate identity<br>Materiali di stampa · Company profile</div>`,
  }),
  // 3 — company profile & brochure
  work("Il lavoro", one("_brochure.png", "Company profile e brochure Parsec 3.26"),
    "Company profile & brochure", "→", "", "#f1f1f3"),
  // 4 — cartellina istituzionale
  work("Il lavoro", one("_cartellina.png", "Cartellina istituzionale Parsec 3.26"),
    "Cartellina istituzionale", "→", "", "#eeeef0"),
  // 5 — biglietti da visita
  work("Il lavoro", one("_biglietti.png", "Biglietti da visita Parsec 3.26"),
    "Biglietti da visita", "→", "", "#f4f4f6"),
  // 6 — carta intestata & corporate
  work("Il lavoro", one("_carta.png", "Carta intestata Parsec 3.26"),
    "Carta intestata & corporate", "→", "tight", "#ffffff"),
  // 7 — sito & presenza online
  work("Il lavoro", one("_sito.png", "Sito Parsec 3.26"),
    "Sito & presenza online", "→", "tight", "#ffffff"),
];
