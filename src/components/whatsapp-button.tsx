...
//
// Non è verde WhatsApp ma della stessa pastiglia scura dell'interruttore:
// l'arancione è l'unico accento del sito e il verde era stato tolto apposta
// (vedi AGENTS.md). A riconoscerlo basta il simbolo.
export default function WhatsappButton() {
  ...
  return (
    <a
      ...
      data-theme="dark"
      className="fixed bottom-24 right-[4.75rem] z-50 flex size-11 items-center justify-center rounded-full border border-cream/15 bg-navy-deep/85 text-cream/70 shadow-lg backdrop-blur-md transition-colors duration-300 hover:border-cream/40 hover:text-cream md:bottom-6 md:right-[5rem]"
    >
      <svg
        viewBox="0 0 24 24"
